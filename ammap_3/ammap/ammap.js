...
AmCharts.wrappedText = function(a, b, c, d, f, e, g, h, k) {
	...
	if (l) {
		...
		if (n.width > h) {
			...
			if (isNaN(p)) {
				if (0 == k)
					for (t = 1; t < n; t++) p = Math.round(b.length / n * t), b = b.substr(0, p) + m + b.substr(p);
...
AmCharts.AmChart = AmCharts.Class({
	...
	write: function(a) {
		if (a = "object" != typeof a ? document.getElementById(a) : a) {
			...
			k && AmCharts.AmExport &&
				!this.AmExport && (this.AmExport = new AmCharts.AmExport(this, k));
	...
	initChart: function() {
		...
		a && (isNaN(a.precision) || (this.precision =
			a.precision), void 0 !== a.thousandsSeparator && (this.thousandsSeparator = a.thousandsSeparator), void 0 !== a.decimalSeparator && (this.decimalSeparator = a.decimalSeparator));
		...
		this.divIsFixed =
			AmCharts.findIfFixed(this.chartDiv);
		...
		this.mouseMode = a;
		(a = this.container) ?
		(a.container.innerHTML = "", a.width = this.realWidth, a.height = this.realHeight, a.addDefs(this), this.chartDiv.appendChild(a.container)) : a = new AmCharts.AmDraw(this.chartDiv, this.realWidth, this.realHeight, this);
		a.chart = this;
	...
	brr: function() {
		...
		if ("amcharts.com" != b || !0 === this.inIframe()) {
			...
			"ammap" ==
			this.product && (e = "http://www.ammap.com/javascript-maps/", g = "Interactive JavaScript maps", h = "JS map by amCharts");
		...
		if (!isNaN(a)) {
			...
			if (this.show) {
				...
				var h = r + y,
					...
					D = this.bulletSize,
					E;
				0 < A || 0 === v ? (0 < y && (a = AmCharts.rect(f, x, w, n, 0, z + 1, F, y, this.cornerRadius), AmCharts.isModern ?
...
AmCharts.handDrawnLine = function(a, b, c, d, f, e, g, h, k, l, m) {
	...
	for (m = 1; m < b.length; m++)
		for (var t = [b[m - 1], b[m]], p = [c[m - 1], c[m]], p = AmCharts.makeHD(t, p, a.handDrawScatter), t = p[0], p = p[1], z = 1; z < t.length; z++) n.push(AmCharts.line(a, [t[z - 1], t[z]], [p[z - 1], p[z]], d, f, e + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
	return n
};
...
AmCharts.AmLegend = AmCharts.Class({
	...
	drawLegend: function() {
		...
		"outside" == b ? (c = e.offsetWidth, f = e.offsetHeight, e.clientHeight && (c = e.clientWidth, f = e.clientHeight)) : (isNaN(c) || (e.style.width =
			c + "px"), e.className = "amChartsLegend " + a.classNamePrefix + "-legend-div");
		this.divWidth = c;
	...
	arrangeEntries: function() {
		...
		if ("top" == a || "bottom" == a || "absolute" == a || "outside" ==
			a) "center" == this.align ? b = e + (h - A.width) / 2 : "right" == this.align && (b = e + h - A.width);
		v.translate(b, l + 1);
	...
	createEntry: function(a) {
		if (!1 !== a.visibleInLegend) {
			...
			if (this.useGraphSettings) {
				...
				if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = k.set(), a.hidden || (d = a.lineColorR, e = a.bulletBorderColorR), m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), AmCharts.setCN(b, m, "graph-stroke"), g.push(m), a.bullet && (a.hidden || (d = a.bulletColorR), m =
					AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, e, a.bulletBorderAlpha)) && (AmCharts.setCN(b, m, "graph-bullet"), m.translate(l + 1, l / 2), g.push(m)), t = 0, m = l, n = l / 3;
				else {
					var p;
...
AmCharts.AmMap = AmCharts.Class({
	...
	handleReleaseOutside: function() {
		if (AmCharts.isModern && !this.preventHover) {
			...
			isNaN(b) ||
				isNaN(c) || !(2 < Math.abs(a.x - b) || Math.abs(a.y - c)) || (this.mapWasDragged = !0, a = {
					type: "dragCompleted",
					zoomX: this.zoomX(),
					zoomY: this.zoomY(),
	...
	processObject: function(a, b, c) {
		if (a) {
			...
			for (d = 0; d < a.length; d++) {
				...
				"image" == c && (f =
					AmCharts.extend(f, new AmCharts.MapImage(this.theme), !0));
...
AmCharts.AreasProcessor = AmCharts.Class({
	...
	process: function(a) {
		...
		b.maxValueReal = k;
		b.minValueReal = l;
		for (f = 0; f < d; f++) e = a[f], isNaN(e.value) ? e.percents = void 0 : (e.percents = (e.value - l) /
			g * 100, l == k && (e.percents = 100));
		for (f = 0; f < d; f++) {
			e = a[f];
			var n = h[e.id];
			c = b.areasSettings;
...
AmCharts.ImagesProcessor = AmCharts.Class({
	...
	createImage: function(a, b) {
		...
		if (u) {
			...
			C.translate(y, l, g)
		} else r ? (isNaN(p) && (p = 10), isNaN(v) && (v = 10), C = d.image(r, 0, 0, p, v), C.node.setAttribute("preserveAspectRatio", "none"), C.setAttr("opacity", h), a.centeredReal && (y = isNaN(a.right) ? -p / 2 : p / 2, l = isNaN(a.bottom) ? -v / 2 : v / 2, C.translate(y, l))) : B && (C =
			d.path(B), n = C.getBBox(), a.centeredReal ? (y = -n.x * g - n.width * g / 2, isNaN(a.right) || (y = -y), l = -n.y * g - n.height * g / 2, isNaN(a.bottom) || (l = -l)) : y = l = 0, C.translate(y, l, g), C.x = y, C.y = l);
